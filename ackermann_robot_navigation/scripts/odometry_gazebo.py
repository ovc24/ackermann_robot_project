...
if __name__ == '__main__':
    rospy.init_node('odom_gazebo_publisher')
    vehicle_name = rospy.get_param('~vehicle_name', 'ackermann_robot')
    global_frame_id = rospy.get_param('~global_frame_id', 'ground_plane')
